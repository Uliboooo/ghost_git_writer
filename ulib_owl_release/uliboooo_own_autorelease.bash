...
cat ./ulib_owl_release/build_on_linux.bash | ssh coyuki@manjaro 'bash -s' -- $branch $ver && success_builds=$((success_builds + 1))
...
scp coyuki@manjaro:~/Develop/remote_builder/ghost_git_writer/release/ggw_${ver}_linux.zip ./release
...
if [ -e ./release/ggw_${ver}_linux.zip ]; then
    echo "✅ success linux zip"
else
